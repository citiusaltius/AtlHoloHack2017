...
namespace HoloToolkit.Unity.InputModule
{
    ...
    public class TapToPlace : MonoBehaviour, IInputClickHandler
    {
        ...
        public float DistanceAdjust = 0.97f;
        /// <summary>
        ...
        {
            if(BuildingManager.Instance.thisCurrentAppMode == BuildingManager.ApplicationMode.Experience) { return; }
            ...
            Vector3 placementPosition = SpatialMappingManager.Instance != null &&
                Physics.Raycast(headPosition, gazeDirection, out hitInfo, 30.0f, SpatialMappingManager.Instance.LayerMask)
                    //? new Vector3(hitInfo.point.x, hitInfo.point.y + HeightAdjust, hitInfo.point.z * ForwardAdjust)
                    ? hitInfo.point * DistanceAdjust
